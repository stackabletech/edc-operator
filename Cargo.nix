...
rec {
  ...
  rootCrate = rec {
    packageId = "stackable-edc-operator";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clap" = rec {
        ...
        edition = "2021";
        crateBin = [];
        sha256 = "0r1g6mrh8hlcn942gg2prs8vzhb5sj2cr6n84vx50634364g2x92";
        dependencies = [
          {
            name = "clap_builder";
      ...
      "clap_builder" = rec {
        ...
        version = "4.4.8";
        edition = "2021";
        sha256 = "1g4mkd9d93alcmrswzk3sif636nrl0q5w8j2g8giwp5j92qz3k87";
        dependencies = [
          {
            name = "anstream";
            packageId = "anstream";
      ...
      "stackable-edc-operator" = rec {
        crateName = "stackable-edc-operator";
        version = "0.0.0-dev";
        edition = "2021";
        crateBin = [
          {
            name = "stackable-edc-operator";
            path = "src/main.rs";
            requiredFeatures = [ ];
          }
        ];
